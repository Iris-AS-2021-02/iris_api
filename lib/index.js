...
const userUrl = 'host.docker.internal';
const userPort = '1024';
const userEntryPoint = 'user';

const URL$1 = `http://${userUrl}:${userPort}/${userEntryPoint}`;
...
const port$1 = '8088';
const entryPoint = 'contacts';

const URL$2 = `http://${url$1}:${port$1}/${entryPoint}`;
...
const URL$6 = `http://${url$4}:${port$4}/${entryPoint$1}`;
console.log(URL$6);
const resolvers$6 = {
	Query: {
		getAllStates: (_) =>
...
const UserURL = `http://${userUrl}:${userPort}/${userEntryPoint}`;
